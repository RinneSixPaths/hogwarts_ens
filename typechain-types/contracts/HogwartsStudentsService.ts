...
export interface HogwartsStudentsServiceInterface extends utils.Interface {
  functions: {
    "addressesToDomains(address)": FunctionFragment;
    ...
    "getRecordBySender()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "addressesToDomains",
  ...
  encodeFunctionData(
    functionFragment: "getRecordBySender",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface HogwartsStudentsService extends BaseContract {
  ...
  estimateGas: {
    ...
    getRecordBySender(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getRecordBySender(overrides?: CallOverrides): Promise<PopulatedTransaction>;
